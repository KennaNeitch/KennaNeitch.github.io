...
class Text:
    ...
    def remove_stopwords(self, tokens):
        #remove all the stopwords from a list of raw_tokens
        return [token for token in tokens if token not in stopwords.words("english")]
...
doyle = [Text(raw_text) for raw_text in texts[:2]]
bronte = [Text(raw_text) for raw_text in texts[:8]]

print(doyle[0].fq.most_common(50))
